# Manual Setup Steps for Minions Audiences
...
Go to **GitHub → mxn2020/minions-audiences → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-audiences` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-audiences-web`
- **GitHub repo**: `mxn2020/minions-audiences`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `audiences.minions.wtf`

### Documentation
- **Netlify site name**: `minions-audiences-docs`
- **GitHub repo**: `mxn2020/minions-audiences`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `audiences.minions.help`

### Blog
- **Netlify site name**: `minions-audiences-blog`
- **GitHub repo**: `mxn2020/minions-audiences`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `audiences.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `audiences.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `audiences.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `audiences.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-audiences/sdk`](https://www.npmjs.com/package/@minions-audiences/sdk)
- CLI: [`@minions-audiences/cli`](https://www.npmjs.com/package/@minions-audiences/cli)
...
Your package: [`minions-audiences`](https://pypi.org/project/minions-audiences/)
...
| Item | Value |
|------|-------|
| Project | `minions-audiences` |
| SDK (npm) | `@minions-audiences/sdk` |
| CLI (npm) | `@minions-audiences/cli` |
| Python (PyPI) | `minions-audiences` |
| GitHub | `github.com/mxn2020/minions-audiences` |
| Docs domain | `audiences.minions.help` |
| Blog domain | `audiences.minions.blog` |
| App domain | `audiences.minions.wtf` |
