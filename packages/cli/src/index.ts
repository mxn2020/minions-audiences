...
/**
 * @minions-audiences/cli — CLI for Minions Audiences
 *
...
import { customTypes } from '@minions-audiences/sdk';
...
program
    .name('audiences')
    .description('Ideal customer profiles, niche definitions, market segments, and target audience personas')
    .version('0.1.0');
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Audiences'));
        console.log(chalk.dim('Ideal customer profiles, niche definitions, market segments, and target audience personas'));
        console.log('');
        console.log(`  SDK:      ${chalk.cyan('@minions-audiences/sdk')}`);
        console.log(`  CLI:      ${chalk.cyan('@minions-audiences/cli')}`);
        console.log(`  Python:   ${chalk.cyan('minions-audiences')}`);
